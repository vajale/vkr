...
import { type DocumentBlock, type DocumentBlockType } from "../../../components/PageView/model/types";
...
export const documentPageSlice = createSlice({
    ...
    reducers: (create) => ({
        ...
        updateDocumentBlock: create.reducer(
            (state, action: PayloadAction<DocumentBlock>) => {
